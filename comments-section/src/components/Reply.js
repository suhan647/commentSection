      ...
      <div className="reply-section">
        <div className="comment flex-desktop">
          <div className="comment-rate comment-rate-flex-column">
            <img alt="icon" onClick={increaseScore} src="../images/icon-plus.svg" />
            <p>{score}</p>
            <img alt="icon" onClick={decreaseScore} src="../images/icon-minus.svg" />
          </div>
          <div>
            <div className="user-info">
              <img alt="icon" className="user-logo" src={props.image} />
              ...
              {props.currentUser ? (
                <div className="comment-edit hide">
                  <span onClick={props.handleDelete}>
                    <img alt="icon" src="../images/icon-delete.svg" />
                    <span className="comment-edit-delete">Delete</span>
                  </span>
                  <span onClick={props.handleEdit}>
                    <img alt="icon" src="../images/icon-edit.svg" />
                ...
                <div className="comment-edit hide">
                  <div onClick={props.handleReply}>
                    <img alt="icon" src="../images/icon-reply.svg" />
