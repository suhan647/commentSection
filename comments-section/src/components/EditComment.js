  ...
  return (
    <div className="comment flex-desktop">
      <div className="comment-rate comment-rate-flex-column">
        <img alt="svgs" onClick={increaseScore} src="../images/icon-plus.svg" />
        <p>{score}</p>
        <img alt="svgs" onClick={decreaseScore} src="../images/icon-minus.svg" />
      </div>
      <div className="flex-column">
        <div className="user-info">
          <img alt="svgs" className="user-logo" src={props.image} />
          ...
          {props.currentUser ? (
            <div className="comment-edit hide">
              <span onClick={props.handleDelete}>
                <img alt="svgs" src="../images/icon-delete.svg" />
                <span className="comment-edit-delete">Delete</span>
              </span>
              <span onClick={props.handleEdit}>
                <img alt="svgs" src="../images/icon-edit.svg" />
            ...
            <div className="comment-edit hide">
              <div onClick={props.handleReply}>
                <img alt="svgs" src="../images/icon-reply.svg" />
