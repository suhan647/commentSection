  ...
  return (
    <div className="comment flex-desktop">
      <div className="comment-rate comment-rate-flex-column">
        <img alt="images" onClick={increaseScore} src="../images/icon-plus.svg" />
        <p>{score}</p>
        <img alt="images" onClick={decreaseScore} src="../images/icon-minus.svg" />
      </div>
      <div>
        <div className="user-info">
          <img alt="images" className="user-logo" src={props.image} />
          ...
          {props.currentUser ? (
            <div className="comment-edit hide">
              <span onClick={props.handleDelete}>
                <img alt="images" src="../images/icon-delete.svg" />
                <span className="comment-edit-delete">Delete</span>
              </span>
              <span onClick={props.handleEdit}>
                <img alt="images" src="../images/icon-edit.svg" />
            ...
            <div className="comment-edit hide">
              <div onClick={props.handleReply}>
                <img alt="images" src="../images/icon-reply.svg" />
